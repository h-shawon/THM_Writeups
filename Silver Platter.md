### Open Ports 
```bash
rustscan -a 10.10.149.150 -- -A 

Open 10.10.149.150:22
Open 10.10.149.150:80
Open 10.10.149.150:8080
...
|     Date: Mon, 27 Jan 2025 02:09:55 GMT
...
|     Content-Length: 74
|     Content-Type: text/html
|     Date: Mon, 27 Jan 2025 02:09:53 GMT
|_    <html><head><title>Error</title></head><body>404 - Not Found</body></html>
1 service unrecognized despite returning data. If you know the service/version, please submit the following fingerprint at https://nmap.org/cgi-bin/submit.cgi?new-service :
SF-Port8080-TCP:V=7.95%I=7%D=1/27%Time=6796EAF1%P=x86_64-pc-linux-gnu%r(Ge
SF:tRequest,C9,"HTTP/1\.1\x20404\x20Not\x20Found\r\nConnection:\x20close\r
SF:\nContent-Length:\x2074\r\nContent-Type:\x20text/html\r\nDate:\x20Mon,\
SF:x2027\x20Jan\x202025\x2002:09:53\x20GMT\r\n\r\n<html><head><title>Error
...
In web server page
![[sp1.png]]
In the contact page a username found `scr1ptkiddy` and another finding is `silverpeas`
![[sp2.png]]
After that I have found 
![[sp3.png]]
Then I generated a password list
```bash
cewl http://silverpeas.thm > pass.txt
```
Using that password list I bruteforce the login page and get the password `adipiscing`. 
![[sp4.png]]
Then I logged in as `scr1ptkiddy`
![[sp5.png]]
In the notification
![[sp6.png]]
I oppend the message and found the message ID=5.
![[sp8.png]]
I changed the ID to 6 and found:
![[sp7.png]]
SSH credentials
```
username: tim
...
```
Using this credentials I logged in as tim and obtained the user flag.
![[sp9.png]]
In `/var/log` directory I give the following command for user `tyler`
```bash
grep -iR tyler
```
And found this 
...
Using that password I logged in as tyler
![[sp11.png]]
And tyler is the root user 
![[sp12.png]]
